...
#include "../25060_LPW2_LAB3B_Solution.X/myDefinitions.h"
#include "../25060_LPW2_LAB3B_Solution.X/AppTasks.h"
#include "../25060_LPW2_LAB3B_Solution.X/LEDTasks.h"
#include "../25060_LPW2_LAB3B_Solution.X/main.h"
...
static uint8_t status;    
    switch(myApp){
        ...
        case SAMPLE:
            ...
            break;
        case TRANSMIT:
            sprintf((char*)myAppData.TXData,"< %d %ld>",myAppData.sample, SW0_Get());
    ...
    if(myAppData.sample>myAppData.setPoint)
        TEST_LED_Set();
    else
        TEST_LED_Clear();
